...
class FacturadisenoCreate extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        $urlimage1 = Storage::disk('s3_public')->put('disenos-comprobantes/facturas', $this->image1, 'public');


        if($this->image2){
            $urlimage2 = Storage::disk('s3_public')->put('disenos-comprobantes/facturas', $this->image2, 'public');
        } else {
    ...
    {
        return view('livewire.admin.facturadiseno-create');
    }
}
