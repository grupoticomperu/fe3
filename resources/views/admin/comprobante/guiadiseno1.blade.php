...
<body>
    ...
    <div class="box center">
        <div class="doc-title">GUIA DE REMISIÓN ELECTRÓNICA</div>
        <div class="doc-number">{{ $boleta->serie }} - {{ $boleta->numero }}</div>

        <div class="date-pill">
            <span class="date-label">Fecha de inicio de traslado</span>
    ...
    <div>
        <div class="row">
            <span class="label">CLIENTE:</span> {{ $boleta->customer->nomrazonsocial }}
        </div>
        <div class="row">
            <span class="label">DIRECCIÓN:</span> {{ $boleta->customer->address }}
        </div>
        {{-- <div class="row">
            <span class="label">FORMA PAGO:</span> {{ $boleta->paymenttype->name }}
        </div> --}}
    </div>
    ...
    <table>
        ...
        <tbody>
            @foreach ($temporals as $temporal)
                <tr>
                    <td class="col-prod">{{ $temporal->codigobarras }}</td>
                    <td class="col-prod">{{ $temporal->name }}</td>
                    <td class="col-qty amount">{{ $temporal->quantity }}</td>
                    <td class="col-pu amount">{{ $temporal->um }}</td>
 ...
 --}}
            ...
            <tr>
                <td class="key grand-total">Doc. de Referencia</td>
                <td class="val grand-total">{{ $boleta->pertenecea }}</td>
            </tr>
            ...
            <tr>
                <td class="key grand-total">Motivo de traslado</td>
                <td class="val grand-total">{{ $boleta->motivotraslado->description }}</td>
            </tr>
        </table>

        <div class="words">
            <span class="label">Observaciones:</span> {{ $boleta->observacion }}
        </div>
    </div>
