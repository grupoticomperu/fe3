        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-800">
                    {{ __('Creación de un Punto de Partida') }}
                </h2>
                <p class="mt-1 text-sm text-gray-500">
                    Registra una dirección de salida para guías y envíos (ubigeo, predeterminado y estado).
                </p>
            </div>
        ...
        <div class="bg-white border border-gray-200 shadow-sm rounded-2xl">
            ...
            <div class="flex items-start justify-between px-6 py-5 border-b border-gray-100">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Completa la dirección y selecciona el ubigeo.</p>
                </div>
            ...
            <div class="p-6">
                ...
                {{-- Loader opcional si quieres cuando cambian selects --}}
                <div wire:loading wire:target="department_id,province_id,district_id"
                    ...
                    <strong class="font-semibold">Cargando ubigeo...</strong>
                    <span class="block text-sm">Actualizando provincias y distritos.</span>
                </div>
            </div>
        </div>
    </div>
