...
class ComprobanteCreaterapido extends Component
{
    //public $msg = '';
    ...
    public function render()
    {
        ...
        return view('livewire.admin.comprobante-createrapido', compact('customers', 'currencies', 'tipocomprobantes', 'cart', 'tipodocumentos', 'tipodeoperacions'));
    }
}
