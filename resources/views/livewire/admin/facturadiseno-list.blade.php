<div wire:init="loadFacturadisenos">
    ...
    <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
        <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
            ...
            <div class="flex items-center justify-center">
                <a href=" {{ route('admin.facturadiseno.create') }} "
            ...
            @if (count($facturasdisenos))
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($facturasdisenos as $facturasdiseno)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    {{ $facturasdiseno->nameblade }}
                                </td>


                                <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">

                                    @if ($facturasdiseno->image1)
                                        <img src="{{ Storage::disk('s3_public')->url($facturasdiseno->image1) }}"
                                            width="200" alt="">
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @switch($facturasdiseno->state)
                                        @case(0)
                                            {{-- @can('boletasdisenos Update') --}}
                                            <span wire:click="activar({{ $facturasdiseno->id }})"
                                        ...
                                        @case(1)
                                            {{-- @can('boletasdisenos Update') --}}
                                            <span wire:click="desactivar({{ $facturasdiseno->id }})"
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    {{-- @can('Boletadiseno Update') --}}
                                        <a href=" {{ route('admin.facturadiseno.edit', $facturasdiseno->id) }} "
                                            class="btn btn-green">
                                   ...
                                   {{--  @endcan
                                    ...
                                    @can('Boletadiseno Delete') --}}
                                        <a class="btn btn-red"
                                            wire:click="$emit('deleteFacturadiseno', {{ $facturasdiseno->id }}) ">
                ...
                @if ($facturasdisenos->hasPages())
                    <div class="px-6 py-4">
                        {{ $facturasdisenos->links() }}
                    </div>
                @endif
            @endif
        </x-table>
    ...
    @push('scripts')
        ...
        <script>
            Livewire.on('deleteFacturadiseno', facturadisenoId => {
                Swal.fire({
                    title: 'Estas seguro?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.facturadiseno-list', 'delete', facturadisenoId);
