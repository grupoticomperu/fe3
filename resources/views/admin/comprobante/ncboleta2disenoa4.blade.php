...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Items table (SIN líneas por item) */
        table.items {
            width: 100%;
            border-collapse: collapse;
            margin-top: 6px;
        ...
        /* Encabezado: mantiene línea inferior */
        ...
        /* Celdas: SOLO líneas verticales (sin horizontales) */
        ...
        /* Asegura borde vertical también en el header */
        table.items thead th {
            border-left: 1px solid #000;
            border-right: 1px solid #000;
        }

        /* Para que el borde exterior se vea limpio */
        ...
        <tr>
            ...
            <td style="width: 30%; vertical-align: top;">
                <div class="box-strong text-center">
                    ...
                    <div class="h2 mt-8">NOTA DE CREDITO BOLETA <br> ELECTRÓNICA</div>
