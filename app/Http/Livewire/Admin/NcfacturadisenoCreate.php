...
class NcfacturadisenoCreate extends Component
{
    ...
    public function save()
    {
        ...
        $urlimage1 = Storage::disk('s3_public')->put('disenos-comprobantes/ncfacturas', $this->image1, 'public');


        if ($this->image2) {
      
            $urlimage2 = Storage::disk('s3_public')->put('disenos-comprobantes/ncfacturas', $this->image2, 'public');
        } else {
        ...
        $this->emit('alert', 'El Diseño de Nota de Crédito de facturas se creo correctamente');
        return redirect()->route('admin.ncfacturadiseno.list');
    }

    public function render()
    {
        return view('livewire.admin.ncfacturadiseno-create');
    }
}
