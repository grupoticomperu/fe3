...
class GuiadisenoCreate extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        $urlimage1 = Storage::disk('s3_public')->put('disenos-comprobantes/guias', $this->image1, 'public');


        if ($this->image2) {

            $urlimage2 = Storage::disk('s3_public')->put('disenos-comprobantes/guias', $this->image2, 'public');
        } else {
        ...
        $this->emit('alert', 'El Diseño de Guias se creo correctamente');
    ...
    {
        return view('livewire.admin.guiadiseno-create');
    }
}
