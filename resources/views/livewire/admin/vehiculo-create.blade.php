        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-800">
                    {{ __('Creación de un Vehículo') }}
                </h2>
                <p class="mt-1 text-sm text-gray-500">
                    Registra un vehículo (placa, modelo, marca, TUCE) y define su estado.
                </p>
            </div>
        ...
        <div class="bg-white border border-gray-200 shadow-sm rounded-2xl">
            ...
            <div class="flex items-start justify-between px-6 py-5 border-b border-gray-100">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Completa los campos obligatorios. La placa se recomienda en mayúsculas.
                    </p>
                </div>
            ...
            <div class="p-6">
                ...
                <div wire:loading wire:target="save"
                    ...
                    <strong class="font-semibold">Procesando...</strong>
