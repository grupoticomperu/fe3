<div wire:init="loadGuiadisenos">
    ...
    <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
        <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
            ...
            <div class="flex items-center justify-center">
                <a href=" {{ route('admin.guiadiseno.create') }} "
            ...
            @if (count($guiasdisenos))
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($guiasdisenos as $guiasdiseno)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    {{ $guiasdiseno->nameblade }}
                                </td>


                                <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">

                                    @if ($guiasdiseno->image1)
                                        <img src="{{ Storage::disk('s3_public')->url($guiasdiseno->image1) }}"
                                            width="200" alt="">
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @switch($guiasdiseno->state)
                                        @case(0)
                                            {{-- @can('guiasdisenos Update') --}}
                                            <span wire:click="activar({{ $guiasdiseno->id }})"
                                        ...
                                        @case(1)
                                            {{-- @can('guiasdisenos Update') --}}
                                            <span wire:click="desactivar({{ $guiasdiseno->id }})"
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    {{-- @can('Boletadiseno Update') --}}
                                        <a href=" {{ route('admin.guiadiseno.edit', $guiasdiseno->id) }} "
                                            class="btn btn-green">
                                   ...
                                   {{--  @endcan
                                    ...
                                    @can('Boletadiseno Delete') --}}
                                        <a class="btn btn-red"
                                            wire:click="$emit('deleteGuiadiseno', {{ $guiasdiseno->id }}) ">
    ...
    @push('scripts')
        ...
        <script>
            Livewire.on('deleteGuiadiseno', guiadisenoId => {
                Swal.fire({
                    title: 'Estas seguro?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.guiadiseno-list', 'delete', guiadisenoId);
