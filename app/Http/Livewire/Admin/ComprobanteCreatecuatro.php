...
class ComprobanteCreatecuatro extends Component
{
    //public $msg = '';
    ...
    public function getLegends()
    {
        ...
        $this->legends[] = [
            'code' => '1000',
            'value' => $formatter->toInvoice((float) $this->subtotall, 4)
    ...
    public function save()
    {
        ...
        $sunat = new SunatService($comprobante, $this->company, $temporals, $boleta, $this->total, $this->totalenletras, null);
    ...
    public function render()
    {
        ...
        $productos = Product::where('company_id', $company_id)->paginate(8);
        return view('livewire.admin.comprobante-createcuatro', compact('customers', 'currencies', 'tipocomprobantes', 'cart', 'tipodocumentos', 'tipodeoperacions', 'productos'));
    }
}
