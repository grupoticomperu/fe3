<div wire:init="loadTransportistas">
                        ...
                        @foreach ($transportistas as $transportista)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    @can('Transportista Update')
                                        <a href=" {{ route('transportista.edit', $transportista->id) }} "
                                            class="btn btn-green">
                                            <i class="fa-solid fa-pen-to-square"></i></a>
                                    @endcan

                                    @can('Transportista Delete')
                                        <a class="btn btn-red"
    ...
    @push('scripts')
        ...
        <script>
            Livewire.on('deleteTransportista', transportistaId => {
                Swal.fire({
                    title: 'Estas seguro?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.transportista-list', 'delete', transportistaId);
