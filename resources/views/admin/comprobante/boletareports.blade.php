...
<body>
    <div>
        ...
        <p style="word-wrap: break-word; overflow-wrap: break-word;">
            CLIENTE: {{ $comprobante->customer->nomrazonsocial }}
        </p>
        {{-- <p>DIRECCIÓN: {{ $comprobante->customer->address }} </p> --}}

        <p style="word-wrap: break-word; overflow-wrap: break-word;">
            DIRECCIÓN: {{ $comprobante->customer->address }}
        </p>

        <p>FORMA PAGO: CONTADO {{ $comprobante->paymenttype_id }}</p>
        <hr>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="pre text-right">P/U</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount">{{ number_format($temporal->saleprice, 2) }}</td>
                    <td class="amount">{{ number_format($temporal->saleprice * $temporal->quantity, 2) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="amount">Ope Gravadas:</td>

                <td class="amount">{{ number_format($comprobante->valorventa, 2) }}</td>
            </tr>
            ...
            <tr>
                ...
                <td class="amount">ICBPER:</td>

                <td class="amount">{{ number_format($comprobante->icbper, 2) }}</td>
            </tr>
            ...
            <tr>
                ...
                <td class="amount">{{ number_format($comprobante->mtoigv, 2) }}</td>
            </tr>
