...
class NcboletadisenoCreate extends Component
{
    ...
    public function save()
    {
        ...
        $urlimage1 = Storage::disk('s3_public')->put('disenos-comprobantes/ncboletas', $this->image1, 'public');


        if ($this->image2) {
      
            $urlimage2 = Storage::disk('s3_public')->put('disenos-comprobantes/ncboletas', $this->image2, 'public');
        } else {
    ...
    {
        return view('livewire.admin.ncboletadiseno-create');
    }
}
